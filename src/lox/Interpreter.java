...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void>
{
    ...
    public Object visitAssignExpr(Expr.Assign assign)
    {
        ...
        if (distance != null)
        {
            environment.assignAt(distance, assign.name, val);
        }
        else {
    ...
    @Override
    public Object visitLogicalExpr(Expr.Logical logic)
    {
    ...
    {
        LoxFunction loxFunc = new LoxFunction(func, environment, false);
        environment.define(func.name.lexeme, loxFunc);
        return null;
    }

    @Override
    public Void visitReturnStmt(Stmt.Return ret)
    {
        Object value = null;
